 ...
 */
 ...
 public class ConfigManager<P> {
     ...
     private void setEntityDataOptions(Map<String, Object> yamlData, Settings settings) {
         ...
         // New ride stats settings
         settings.getEntityData().getRideStats().setEnabled(getBoolean(yamlData, "spoof.entity-data.ride-stats.enabled", true));
         settings.getEntityData().getRideStats().setSpoofMovementSpeed(getBoolean(yamlData, "spoof.entity-data.ride-stats.spoof-movement-speed", true));
         settings.getEntityData().getRideStats().setSpoofJumpStrength(getBoolean(yamlData, "spoof.entity-data.ride-stats.spoof-jump-strength", true));
         settings.getEntityData().getRideStats().setSpoofInventorySlots(getBoolean(yamlData, "spoof.entity-data.ride-stats.spoof-inventory-slots", true));
